...
import { Svg, PathBanner, PathOctoTail, StyledPath } from '../svg';

interface GithubForkBannerProps {
  direction?: string;
  size?: number;
  customHref: string;
  bannerColor?: string;
...
export const GithubForkBanner = (props: GithubForkBannerProps) => {
  const { direction, size, customHref, bannerColor, octoColor } = props;
